      ...
      <div class="page-header-content">
        <a-card :bordered="false" class="content">
          ...
          <div class="table-page-operator-wrapper">
            <a-button @click="$refs.createModal.show()" type="primary" v-hasPermi="['system:notice:add']" ghost>新增</a-button>
            <a-button @click="handleDeleteBatch(selectedRowKeys)" :disabled="selectedRowKeys.length === 0" v-hasPermi="['system:notice:remove']">删除</a-button>
            <a-dropdown>
              <a-menu slot="overlay">
          ...
          >
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="$refs.createModal.show(record)" v-hasPermi="['system:notice:edit']">编辑</a>
              ...
              <a-dropdown>
                ...
                <a-menu slot="overlay">
                  <a-menu-item>
                    <a href="javascript:;" @click="handleDelete(record)" v-hasPermi="['system:notice:remove']">删除</a>
                  </a-menu-item>
                </a-menu>
              </a-dropdown>
            </span>
